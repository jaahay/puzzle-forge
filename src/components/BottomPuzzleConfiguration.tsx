...
export const BottomPuzzleConfiguration = (props: BottomPuzzleConfigurationProps) => {
  ...
  const newPuzzleAction = <GenerationActions className="new-puzzle-actions" isGenerating={isGenerating} canGenerate={selectedPuzzleIsGeneratable} showRandomize={showRandomize} randomLabel="New puzzle" onRandomize={onRandomize} />;
