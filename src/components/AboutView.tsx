export const AboutView = () => (
  <section class="site-changelog about-view" id="about" aria-labelledby="about-title">
    ...
    <article>
      ...
      <p>
        Puzzle generation runs in a Web Worker so the catalog remains responsive while seeded boards, deals, and grids are
        produced.
      </p>
    </article>
    <article>
      ...
      <p>
        The catalog is meant to stay extensible: new puzzle definitions, interaction models, and checkers can join without
        turning the app shell into a tangle.
      </p>
    </article>
  </section>
);
